                ...
                >
                  <Dialog>
                        ...
                        <div className="relative bg-white rounded-xl border border-gray-200 p-6 shadow-lg group-hover:shadow-xl transition-all duration-300 h-[380px] flex flex-col">
                          <div className="flex justify-center mb-4">
                            <div className="h-20 w-20 rounded-full overflow-hidden border-4 border-indigo-500/30">
                              <img alt="John Melvin" className="w-full h-full object-cover object-top" src="/lovable-uploads/901d8619-8060-4f79-be62-452dfb6c77d2.png" />
                            </div>
                          </div>
                          <div className="text-center flex-grow flex flex-col">
                    ...
                    <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                      <div className="p-6">
                        <div className="flex items-center gap-6 mb-6">
                          <img src="/lovable-uploads/901d8619-8060-4f79-be62-452dfb6c77d2.png" alt="John Melvin" className="w-24 h-24 rounded-full object-cover object-top" />
                          <div>
